...
FROM OPENDATASOURCE('SQLNCLI', 'Data Source=DESKTOP-B4L9B2O;Integrated Security=SSPI').[TypicalBranch].[dbo].[Products] as prod 
	INNER JOIN OPENDATASOURCE('SQLNCLI', 'Data Source=DESKTOP-B4L9B2O;Integrated Security=SSPI').[TypicalBranch].[dbo].[Categories] AS cat ON prod.CategoryID = cat.CategoryID
